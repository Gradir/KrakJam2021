...
{
	public static void ForGizmo(Vector3 from, Vector3 to, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f)
	{
	...
	public static void ForGizmo(Vector3 from, Vector3 to, Color color, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f)
	{
		Gizmos.color = color;
		ForGizmo(from, to, arrowHeadLength, arrowHeadAngle);
	}
