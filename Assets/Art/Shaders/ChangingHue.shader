...
Shader "ChangingHue"
{
	Properties
	{
		...
		[ASEBegin]_Hue("Hue", Range( 0 , 1)) = 0
		_Color("Color", 2D) = "white" {}
		[Normal]_Normal("Normal", 2D) = "white" {}
		[ASEEnd]_MaskMap("Mask Map", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Color = packedInput.ase_texcoord5.xy * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode4 = tex2D( _Color, uv_Color );
				float3 hsvTorgb1 = RGBToHSV( tex2DNode4.rgb );
				float3 hsvTorgb5 = HSVToRGB( float3(_Hue,hsvTorgb1.y,hsvTorgb1.z) );
				float4 appendResult6 = (float4(hsvTorgb5 , tex2DNode4.a));
				...
				float4 tex2DNode19 = tex2D( _MaskMap, uv_MaskMap );
				
				surfaceDescription.Albedo = appendResult6.xyz;
				...
				surfaceDescription.Smoothness = tex2DNode19.a;
				surfaceDescription.Occlusion = tex2DNode19.g;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Color = packedInput.ase_texcoord.xy * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode4 = tex2D( _Color, uv_Color );
				float3 hsvTorgb1 = RGBToHSV( tex2DNode4.rgb );
				float3 hsvTorgb5 = HSVToRGB( float3(_Hue,hsvTorgb1.y,hsvTorgb1.z) );
				float4 appendResult6 = (float4(hsvTorgb5 , tex2DNode4.a));
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Color = packedInput.ase_texcoord1.xy * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode4 = tex2D( _Color, uv_Color );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Color = packedInput.ase_texcoord3.xy * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode4 = tex2D( _Color, uv_Color );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Color = packedInput.ase_texcoord7.xy * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode4 = tex2D( _Color, uv_Color );
				float3 hsvTorgb1 = RGBToHSV( tex2DNode4.rgb );
				float3 hsvTorgb5 = HSVToRGB( float3(_Hue,hsvTorgb1.y,hsvTorgb1.z) );
				float4 appendResult6 = (float4(hsvTorgb5 , tex2DNode4.a));
...
/*ASEBEGIN
Version=18800
1920;12;1920;1007;1207.315;407.7571;1;True;False
Node;AmplifyShaderEditor.SamplerNode;4;-1139.628,-121.5239;Inherit;True;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;-1;None;3287de45d937b34418b4eb16c1a27c8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2;-927.6283,-362.5239;Inherit;False;Property;_Hue;Hue;0;0;Create;True;0;0;0;False;0;False;0;0.099;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RGBToHSVNode;1;-831.6283,-260.5239;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.HSVToRGBNode;5;-470.6283,-243.5239;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;19;-395.6281,339.4761;Inherit;True;Property;_MaskMap;Mask Map;3;0;Create;True;0;0;0;False;0;False;-1;None;3008d6bc83d360041817752724fa2f4e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-394.6281,150.4761;Inherit;True;Property;_Normal;Normal;2;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;859b2995968925148b3bf58b641f49ad;True;0;True;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;6;-174.6283,-166.5239;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;-555.6283,-361.5239;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;6;3;4;4
WireConnection;3;0;2;0
WireConnection;3;1;1;1
WireConnection;7;0;6;0
WireConnection;7;1;18;0
WireConnection;7;7;19;4
WireConnection;7;8;19;2
WireConnection;7;9;4;4
ASEEND*/
//CHKSM=E63D8A4E25A823834F269A2F26446FA5FA1E4982